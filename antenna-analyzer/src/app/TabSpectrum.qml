...
Item {
    ...
    Timer {
        ...
        running: true
        repeat: true
        onTriggered: backend.handleSpectrumUpdate()
    }
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            Item {
                ...
                Text {
                    id: textLabelV
                    text: qsTr("Spectrum (V-channel), dB")
        ...
        ColumnLayout {
            ...
            Item {
                ...
                Text {
                    id: textLabelI
                    text: qsTr("Spectrum (I-channel), dB")
                    anchors.horizontalCenter: parent.horizontalCenter
                    anchors.top: parent.top
                    anchors.topMargin: 12
                    font.bold: true
    ...
    Component.onCompleted: {
        ...
        backend.handleSpectrumSetup(lineSeriesV, lineSeriesI, axisV_X, axisV_Y, axisI_X, axisI_Y)
    }
}
